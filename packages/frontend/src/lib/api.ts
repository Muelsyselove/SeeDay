...
export async function generateDailySummary(date: string): Promise<{ summary: string | null; generated_at: string | null } | null> {
  const res = await fetch(`${API_BASE}/api/daily-summary/generate`, {
    method: 'POST',
    headers: {
